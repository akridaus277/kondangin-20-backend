...
func (s *authService) RegisterUser(req dto.RegisterUserRequest) (*dto.RegisterUserResponse, error) {
...
func (s *authService) LoginUser(req dto.LoginUserRequest) (*dto.LoginUserResponse, error) {
